...
Customer.create(user_id: '1', name: 'customer-example-4', address: '東京都千代田区平河町二丁目3番19号', postal_code: '000000000',
                telephone_number: '00000000000')
Customer.create(user_id: '2', name: 'customer-example-5', address: '東京都千代田区平河町二丁目3番19号', postal_code: '000000000',
                telephone_number: '00000000000')
Customer.create(user_id: '3', name: 'customer-example-6', address: '東京都千代田区平河町二丁目3番19号', postal_code: '000000000',
                telephone_number: '00000000000')
Customer.create(user_id: '4', name: 'customer-example-7', address: '東京都千代田区平河町二丁目3番19号', postal_code: '000000000',
                telephone_number: '00000000000')
Customer.create(user_id: '5', name: 'customer-example-8', address: '東京都千代田区平河町二丁目3番19号', postal_code: '000000000',
                telephone_number: '00000000000')
Customer.create(user_id: '6', name: 'customer-example-9', address: '東京都千代田区平河町二丁目3番19号', postal_code: '000000000',
                telephone_number: '00000000000')
Customer.create(user_id: '7', name: 'customer-example-10', address: '東京都千代田区平河町二丁目3番19号', postal_code: '000000000',
                telephone_number: '00000000000')
Customer.create(user_id: '8', name: 'customer-example-11', address: '東京都千代田区平河町二丁目3番19号', postal_code: '000000000',
                telephone_number: '00000000000')
Customer.create(user_id: '9', name: 'customer-example-12', address: '東京都千代田区平河町二丁目3番19号', postal_code: '000000000',
                telephone_number: '00000000000')
Customer.create(user_id: '10', name: 'customer-example-13', address: '東京都千代田区平河町二丁目3番19号', postal_code: '000000000',
                telephone_number: '00000000000')
...
Item.create(name: 'item-example-10', content: 'example-10',
            image: File.open('./db/fixtures/142_refileDownloadImage.png'))
Item.create(name: 'item-example-11', content: 'example-11',
            image: File.open('./db/fixtures/142_refileDownloadImage.png'))
